...
# Dependencies:
- `ErrorMetricsTypes`: Provides the core ErrorMetrics types.
- `metric.jl`: Provides the core metric definitions, including statistical measures (e.g., RMSE, correlation) and custom metrics for SINDBAD experiments.
